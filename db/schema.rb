...
ActiveRecord::Schema[7.0].define(version: 2023_02_09_204118) do
  ...
  create_table "custom_fields", force: :cascade do |t|
    ...
    t.text "select_options", default: [], null: false, array: true
  ...
  create_table "users", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["custom_fields_data"], name: "index_users_on_custom_fields_data", using: :gin
  end
